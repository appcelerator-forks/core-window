(function() {
    ...
    function createConsoleLogger(type) {
        console[type] = function() {
            ...
            0 === args.length ? args.push(LINE_RESET) : args[0] = LINE_RESET + args[0].toString().split(/(?:\r\n|\n|\r)/).join("\n" + LINE_RESET);
            Ti.API.log("log" === type ? "info" : type, require("titanium/util").format.apply(this, args));
        };
    }
    require.modules = {};
    ...
    require.register("reporters/base.js", function(module, exports, require) {
        ...
        var tty = require("browser/tty"), diff = require("browser/diff"), ms = require("../ms");
    ...
    require.register("reporters/xunit.js", function(module, exports, require) {
        ...
        function test(test) {
            ...
            } else test.pending ? process.stdout.write(tag("testcase", attrs, false, tag("skipped", {}, true))) : process.stdout.write(tag("testcase", attrs, true));
        }
